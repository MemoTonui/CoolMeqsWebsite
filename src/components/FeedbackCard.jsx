...
const FeedbackCard = ({ content, name, title, img }) => (
  <div className="flex justify-between flex-col px-5 py-5 rounded-[20px] max-w-[390px] md:mr-10 sm:mr-5 mr-0  feedback-card">
    ...
    />
    <p className="font-inter font-normal text-[18px] leading-[32px] text-slate-900 my-10">
      {content}
    </p>
    <div className="flex flex-row">
      ...
      <div className="flex flex-col ml-4">
        ...
        <p className="font-inter font-normal text-[16px] leading-[24px] text-slate-700 my-10">
          {title}
        </p>
      </div>
    </div>
